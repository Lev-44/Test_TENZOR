...
class SbisContactsPage:
    def __init__(self, browser):
        ...
        self.clients_button_xpath = ('//*[@id="contacts_clients"]/'
                                     'div[1]/div/div/div[2]/div/a')
        self.sila_people = ('//*[@id="container"]/div[1]/div/div[5]/'
                            'div/div/div[1]/div/p[1]')
        self.anchor_xpath_to_pic = ('//*[@id="container"]/div[1]/'
                                    'div/div[5]/div/div/div[1]/div/p[4]/a')
        self.pic_xpath_prefix = ('html/body/div[1]/div/div/div'
                                 '/div[2]/div[1]/div[2]/div[1]/'
                                 'div/div/div[1]/div/div[4]/div[2]/div ')
        self.anchor_xpath_to_region = ('//*[@id="container"]'
                                       '/div[1]/div/div[3]/div[2]'
                                       '/div[1]/div/div[2]/span/span')
        self.region_button_xpath = ('//*[@id="popup"]/div[2]/div'
                                    '/div/div/div/div[2]/div/ul/'
                                    'li[{region_id}]/span/span')
    ...
    def click_anchor_to_pic(self):
        ...
        self.browser.execute_script("arguments[0]"
                                    ".scrollIntoView(true);", anchor)
        anchor.click()
    ...
    def click_anchor_to_region(self):
        anchor = (self.browser.find_element
                  (By.XPATH, self.anchor_xpath_to_region))
        self.browser.execute_script("arguments[0].click()", anchor)
        time.sleep(5)

    def select_region(self, region_id):
        region_button_xpath = (self.region_button_xpath.
